...
<section class="order pt-5 mb-5">
  <div class="container">'
    ...
    <form action="/orderuser/add" method="post">
      <!-- menu -->
        ...
        <div class="col-md-7">
          ...
          <div class="konten">
            ...
            <div class="sec" data-aos="fade-down">
              ...
              <div class="box shadow-sm" data-aos="fade-down">
                <img src="/assets/img/Paket5.png" alt="">
                <h4>Paket 5</h4>
          ...
          <div class="konten">
            ...
            <div class="sec" data-aos="fade-down">
              ...
              <div class="box shadow-sm" data-aos="fade-down">
                <img src="/assets/img/nasigoreng.png" alt="">
                <h4>Nasi Goreng</h4>
    ...
    <!-- struk -->
    <div class="col-md-4 mt-3 pl-2 pt-5" id="detail-pesanan">
      <div class="card struk sticky-top" data-aos="fade-up">
        ...
        <div class="card-footer bg-white border-top text-muted">
          ...
          <a href="/orderuser/pembayaran" class="btn btn-success w-100">Lanjutkan Pesanan</a>
        </div>
      </div>
    </div>
  </div>
